...
* Parameter estimation: Three files are generated for this step. (i) Output of *emcee.PTsampler* saved as an pickled object, (ii) Posterior plot of \( \beta \ B \) and error parameter, (iii) A plot of walker positions for \( \beta \ B \) parameter and \( \beta \ B \) posterior.
